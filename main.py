...
class Test(MDApp):
    ...
    def __init__(self, **kwargs):
        ...
        int_names=inf.interface_data.get_if_names()
        ...
        self.menu_if_names = MDDropdownMenu(
            ...
            width_mult=inf.interface_data.get_max_name_len(int_names),  # Ustawianie szerokości wiersza
        )
    ...
    def packet_data_get_info(self,current_interface):
        interface_packets_values=inf.interface_data.get_packet_interface_data(current_interface)
    ...
    def get_net_usage_info(self,current_interface):
        interface_speed_values=inf.interface_data.net_usage(current_interface)
